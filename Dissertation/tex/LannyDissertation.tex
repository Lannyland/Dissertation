...
\newcommand{\Author}{Rongbin Lanny Lin}
...
\committeememberb{Mark~B.~Colton}
\committeememberc{Kevin~Seppi}
\committeememberd{David~W.~Embley}
...
\documentkeywords{%
    Unmanned Systems, Path Planning, Navigation, Human-Robot Interaction, Adjustable Autonomy, Sliding Autonomy, Bayesian Modeling
}
...
\input{2Chatper_1_Introduction.tex}
\input{3Chapter_2_AAAI_Paper.tex}
\input{4Chapter_3_CMOT_Paper.tex}
\input{5Chapter_4_IROS_Paper.tex}
\input{6Chapter_5_SMC_B_Paper.tex}
\input{7Chapter_6_HRI_Paper.tex}
\input{8Chapter_7_Map_Edit_Interfaces.tex}
\input{9Chapter_8_Conclusion_and_Future_Work.tex}
