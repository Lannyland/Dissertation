...
\caption{A synthetic WiSAR scenario. Left: Multi-modal probability distribution. Middle: A simple \textit{task-difficulty map}. Right: Probability collectible on first visit (combining \textit{probability distribution} and \textit{task-difficulty map}).}
...
Table~\ref{ACompareToMarkers} lists what percentage of participants outperformed full autonomy, EA, and autonomy+1 human input.
